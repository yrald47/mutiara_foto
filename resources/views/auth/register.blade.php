        ...
        <div class="col-md-8">
            ...
            <a href="{{ route('welcome') }}" style="text-align:center;"> <h4>Mutiara Photography</h4></a>
                ...
                <div class="card-header">                     
                    <h4 class="" style="text-align:center;">{{ __('Daftar Member') }}</h4>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Alamat Surel" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            <label for="alamat" class="col-md-4 col-form-label text-md-right">{{ __('Alamat Domisili') }}</label>
